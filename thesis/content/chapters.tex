...
problem is to find the optimal allocation of the finite budget into a range of financial
...
different instruments. Basically, the goal is to maximize the expected return of the
...
There are various existing portfolio management strategies, such as the
Markowitz portfolio theory\cite[p.~4]{sirucek-2015} and the CAPM model.
