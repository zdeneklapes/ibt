...
%stocks, bonds, commodities, and so on.
...
\end{enumerate}
This work focuses on the stocks.
...
%There exist various existing portfolio management strategies, such as the Markowitz mean-variance portfolio optimization proposed by Hanry Markowitz, the Black-Litterman model~\cite{he-2002} and the CAPM model~\cite{fama-2004}.
