...
%    \end{definition}
    ...
    \[ v_\pi(s) = \argmax_a q_\pi(s, a) \quad\]
    ...
    \begin{equation}
        \begin{split}
            \textcolor[RGB]{51,204,51}{v^*(s)} &= \argmax_{a} \in \mathcal{A} \mathbb{E}[R_{t+1} + \gamma \textcolor[RGB]{51,204,51}{v^*(S_{t+1})} | S_t = s, A_t = a] \\
            &= \argmax_{a} \sum_{s', r} p(r, s'|s, a) \left[r + \gamma \textcolor[RGB]{51,204,51}{v^*(s')}  \right]
        \end{split}
    \end{equation}
    ...
    \begin{equation}
        \begin{split}
            \textcolor[RGB]{51,204,51}{q^*(s, a)} &= \mathbb{E}[R_{t+1} + \gamma \argmax_{a'} \in \mathcal{A} \textcolor[RGB]{51,204,51}{q^*(S_{t+1}, a')} | S_t = s, A_t = a] \\
            &= \sum_{s', r} p(r, s'|s, a) \left[r + \gamma \argmax_{a'} \in \mathcal{A} \textcolor[RGB]{51,204,51}{q^*(s', a')}  \right]
        \end{split}
    \end{equation}
...
% Arrows
    ...
    \begin{algorithm}[H]
        ...
        \While{True}{
            ...
            \[
                Q(s, a) \leftarrow Q(s, a) + \alpha \cdot \left( r + \gamma \cdot \argmax_{a'} Q(s', a') - Q(s, a) \right)
            \]
        }
