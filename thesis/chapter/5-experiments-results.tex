...
%    TODO: Table performance with stats from pyfolio
    In the~\cref{tab:performance} we can see overall performance and statistics of the models. The \textbf{bold} values are the best results for each metric. As we can se our model outperform almost all other models in almost all metrics.
    \begin{table}[!ht]
        \centering
        ...
        \begin{tabular}{|l|l|l|l|l|}
            ...
            \textbf{Annual return}       & 0.085                     & \textbf{0.122}            & 0.106        & 0.09                \\ \hline
            \textbf{Cumulative returns}  & 0.621                     & \textbf{0.972}            & 0.81         & ~                   \\ \hline
            \textbf{Annual volatility}   & \textbf{0.181}            & 0.188                     & 0.193        & 0.232               \\ \hline
            \textbf{Sharpe ratio}        & 0.543                     & \textbf{0.706}            & 0.619        & 0.49                \\ \hline
            \textbf{Calmar ratio}        & 0.288                     & \textbf{0.391}            & 0.336        & 0.24                \\ \hline
            \textbf{Stability}           & 0.855                     & \textbf{0.913}            & 0.863        & 0.04                \\ \hline
            \textbf{Max drawdown}        & \textbf{-0.297}           & -0.312                    & -0.316       & -0.375              \\ \hline
            \textbf{Omega ratio}         & 1.118                     & \textbf{1.158}            & 1.134        & 1.14                \\ \hline
            \textbf{Sortino ratio}       & 0.763                     & \textbf{0.994}            & 0.868        & 0.67                \\ \hline
